...
Here, we are interested in calculating posterior probability that $p > \sqrt{p^\prime}$. The Gibbs sampling process gives us new samples: $p'^{(1)}, p'^{(2)},..., p'^{(S)}$. Having $p^{(1)}, p^{(2)},..., p^{(S)}$ from part(1), we calculate:  
